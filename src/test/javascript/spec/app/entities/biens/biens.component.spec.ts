...
import { BiensComponent } from 'app/entities/biens/biens.component';
import { BiensService } from 'app/entities/biens/biens.service';
import { Biens } from 'app/shared/model/biens.model';

describe('Component Tests', () => {
  describe('Biens Management Component', () => {
    let comp: BiensComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BiensComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.biens && comp.biens[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
