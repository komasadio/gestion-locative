...
import { LocataireComponent } from 'app/entities/locataire/locataire.component';
...
describe('Component Tests', () => {
  describe('Locataire Management Component', () => {
    let comp: LocataireComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocataireComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.locataires && comp.locataires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
