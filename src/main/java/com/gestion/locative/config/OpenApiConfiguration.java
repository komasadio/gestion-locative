package com.gestion.locative.config;
...
public class OpenApiConfiguration {
    ...
    public SwaggerCustomizer noApiFirstCustomizer() {
        return docket -> docket.select().apis(Predicates.not(RequestHandlerSelectors.basePackage("com.gestion.locative.web.api")));
    }
    ...
    public Docket apiFirstDocket(JHipsterProperties jHipsterProperties) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.gestion.locative.web.api"))
